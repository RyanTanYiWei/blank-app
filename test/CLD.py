...
@component.add(
    name="a", comp_type="Auxiliary", comp_subtype="Normal", depends_on={"c": 1}
)
def a():
    return incomplete(c())
...
@component.add(
    name="b", comp_type="Auxiliary", comp_subtype="Normal", depends_on={"a": 1}
)
def b():
    return incomplete(a())
...
@component.add(
    name="c", comp_type="Auxiliary", comp_subtype="Normal", depends_on={"b": 1}
)
def c():
    return incomplete(b())
