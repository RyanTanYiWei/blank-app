...
_subscript_dict, _modules = load_model_data(_root, "ClimateModule_NaturalEmissions")
...
# load modules from modules_ClimateModule_NaturalEmissions directory
exec(load_modules("modules_ClimateModule_NaturalEmissions", _modules, _root, []))
